...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1394.0, 1011.0, 50.0, 64.0 ],
					"text" : "2 3 4 5 6 7 8 7 6 5 4 3 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1483.0, 828.0, 75.0, 22.0 ],
					"text" : "2 4 6 8 6 4 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1349.0, 826.0, 45.0, 22.0 ],
					"text" : "2 4 6 8"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1314.0, 695.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1325.0, 920.0, 63.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1037.0, 846.0, 150.0, 48.0 ],
					"text" : "https://www.trysmudford.com/blog/linear-interpolation-functions/"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1087.0, 788.0, 150.0, 34.0 ],
					"text" : "a is the decimal point midway point (use 0.5)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1018.0, 742.0, 266.0, 20.0 ],
					"text" : "const lerp = (x, y, a) => x * (1 - a) + y * a;"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 768.0, 749.0, 160.0, 145.0 ],
					"range" : 128,
					"size" : 128,
					"table_data" : [ 0, 86, 83, 82, 79, 77, 74, 72, 71, 69, 68, 66, 66, 64, 63, 61, 60, 60, 59, 59, 58, 58, 57, 56, 55, 54, 53, 53, 52, 52, 52, 52, 51, 51, 50, 50, 50, 50, 48, 48, 48, 48, 46, 46, 46, 45, 45, 45, 45, 44, 44, 44, 43, 42, 41, 41, 41, 40, 39, 39, 38, 37, 37, 37, 36, 35, 35, 34, 34, 33, 33, 32, 31, 31, 30, 30, 30, 30, 29, 29, 28, 27, 26, 26, 26, 25, 24, 23, 23, 23, 22, 22, 21, 20, 19, 19, 18, 17, 16, 16, 15, 14, 14, 14, 13, 12, 11, 10, 10, 9, 7, 7, 7, 7, 6, 5, 4, 3, 2, 2, 1, 1, 0, 0, 0, 0, 0, 0, 0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1456.0, 695.0, 286.0, 20.0 ],
					"text" : "or do simple calc on numbers and then interlace"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1456.0, 676.0, 324.0, 20.0 ],
					"text" : "need to interpolate between each pair of numbers?"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1317.0, 594.037039339542389, 275.0, 50.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1604.0, 594.037039339542389, 223.0, 36.0 ],
					"text" : "0. 171.428571 328.571429 500. 657.142857 828.571429 1000."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1573.75, 311.0, 132.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1573.75, 370.0, 110.0, 22.0 ],
...
,
					"patching_rect" : [ 999.0, 304.338074000000006, 149.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1434.0, 140.0, 20.0, 20.0 ],
					"text" : "C"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1240.0, 135.0, 34.0, 20.0 ],
					"text" : "Y"
				}
...
,
					"patching_rect" : [ 944.0, 437.0, 127.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1283.0, 223.0, 71.0, 22.0 ],
					"text" : "s rangeMax"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1206.0, 223.0, 68.0, 22.0 ],
					"text" : "s rangeMin"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1086.0, 233.0, 64.0, 22.0 ],
					"text" : "s dataMax"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1014.5, 233.0, 61.0, 22.0 ],
					"text" : "s dataMin"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1269.0, 157.0, 85.0, 20.0 ],
					"text" : "max"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1185.0, 157.0, 71.0, 20.0 ],
					"text" : "min"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1269.0, 192.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1185.0, 192.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1434.0, 223.0, 41.0, 22.0 ],
					"text" : "s time"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1086.0, 412.5, 343.0, 130.5 ],
					"setminmax" : [ 0.0, 1.0 ],
					"setstyle" : 1,
					"signed" : 1,
					"size" : 14,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1028.0, 43.0, 150.0, 20.0 ],
					"text" : "list is 7 items long"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 493.0, 600.0, 77.0, 20.0 ],
					"text" : "min n max"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1434.0, 189.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 944.0, 469.0, 35.0, 22.0 ],
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 240.0, 190.0, 168.0, 20.0 ],
...
, 			{
				"box" : 				{
					"addpoints" : [ 0.0, 1762.806261372644258, 0, 0.0, 1762.806261372644258, 0, 171.428571428571416, 1240.770349385677946, 0, 171.428571428571416, 1240.770349385677946, 0, 328.571428571428498, 1428.225288060230469, 0, 328.571428571428498, 1428.225288060230469, 0, 500.0, 1290.458007846408691, 0, 500.0, 1290.458007846408691, 0, 657.142857142856997, 2000.073834890239141, 0, 657.142857142856997, 2000.073834890239141, 0, 828.571428571428555, 1093.987875672464725, 0, 828.571428571428555, 1093.987875672464725, 0, 1000.0, 500.147088731319457, 0, 1000.0, 500.147088731319457, 0 ],
					"id" : "obj-8",
					"maxclass" : "function",
					"numinlets" : 1,
					"numoutlets" : 4,
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 737.0, 437.0, 200.0, 100.0 ],
					"range" : [ 500.0, 2000.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 999.0, 81.037039339542389, 275.0, 50.0 ],
					"text" : "62541.086933 61029.270932 61572.140434 61173.166391 63228.213826 60604.188888 59091.007828"
				}
...
,
					"patching_rect" : [ 49.360098000000079, 609.0, 201.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "list" ],
					"patching_rect" : [ 49.360098000000079, 649.0, 41.0, 22.0 ],
					"text" : "funnel"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 49.360098000000079, 685.0, 61.0, 22.0 ],
					"text" : "zmap"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 49.238699000000082, 754.0, 54.0, 22.0 ],
					"text" : "combine"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 6,
					"outlettype" : [ "", "", "", "", "", "" ],
					"patching_rect" : [ 49.238699000000082, 819.681487441062927, 71.5, 22.0 ],
					"text" : "spray 6"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "list" ],
					"patching_rect" : [ 49.238699000000082, 718.333341896533966, 56.0, 22.0 ],
					"text" : "listfunnel"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 99.360098000000079, 323.0, 400.0, 220.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "bang" ],
					"patching_rect" : [ 999.0, 140.0, 50.5, 22.0 ],
					"text" : "t l l l b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 1072.5, 207.0, 61.0, 22.0 ],
					"text" : "maximum"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 1007.400000000000091, 207.0, 57.0, 22.0 ],
					"text" : "minimum"
				}
